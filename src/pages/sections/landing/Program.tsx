    ...
    >
      ...
      <div className="relative">
        ...
        <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16 transition-w transition-opacity">
          <h1 className="mb-2 text-5xl md:text-6xl bg-clip-text text-transparent bg-gradient-to-r from-blue-700 to-blue-500 sm:text-[2.5rem] leading-tight font-extrabold" data-aos="zoom-y-out" data-aos-delay="150">Layanan Olah Data Ocean Statistics</h1>
